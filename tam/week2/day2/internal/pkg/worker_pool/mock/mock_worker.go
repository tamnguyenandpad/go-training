...
// Source: internal/pkg/worker_pool/worker_pool.go
//
// Generated by this command:
//
//	mockgen -destination=internal/pkg/worker_pool/mock/mock_worker.go -source=internal/pkg/worker_pool/worker_pool.go
//
...
import (
	...
	worker_pool "github.com/tuannguyenandpadcojp/go-training/tam/week2/day2/internal/pkg/worker_pool"
...
func (m *MockWorkerPool) Submit(job worker_pool.Job) error {
	m.ctrl.T.Helper()
...
func (m *MockJob) Handler() func() worker_pool.Result {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Handler")
	ret0, _ := ret[0].(func() worker_pool.Result)
	return ret0
}
